...
{
    int victoria, vidaActual = player.estadisticas.vitalidad, vidaActualEnemigo = enemy.estadisticasE.vitalidad, danioRecibidoP = 0, danioRecibidoE = 0, turno = 1, accionRealizadaJ, accionRealizadaE;
